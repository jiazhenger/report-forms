(function(version){ 
	...
	ready(function(){
		...
		if( (ie > 0 && ie<= version) || (document.documentMode != undefined && document.documentMode <= version)){
			var style = 'width:100%;height:100%;overflow:hidden;text-align:center;line-height:40px;text-align:center;display:block;background:#fff;position:absolute;left:0;top:0;color:#418cfd;font-size:30px;font-family:Microsoft YaHei;min-height:600px;min-width:500px;';
